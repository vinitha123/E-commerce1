...
<li class="active"><a href="<c:url value='/ContactUs'></c:url>"><span class="glyphicon glyphicon-earphone"></span>ContactUs</a></li>
  ...
  <li class="active"><a href="<c:url value='/all/getcategoryform'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add Category</a></li>
  <li class="active"><a href="<c:url value='/all/getsupplierform'></c:url>"><span class="glyphicon glyphicon-plus"></span>Add supplier</a></li>
  
   
    </security:authorize>
     <security:authorize access="hasRole('ROLE_USER')">
    <li><a href="/frontend/cart/getcart"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
	</security:authorize>
	</ul>
